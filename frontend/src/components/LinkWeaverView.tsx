...
export const LinkWeaverView: React.FC<LinkWeaverViewProps> = ({ nodes, onAddNode }) => {
  ...
  return (
    <>
      ...
      `}</style>
      <div className="link-weaver-container" style={{
        paddingLeft: '2.65rem',
        ...
        <header style={{ ...styles.header, marginTop: 0, paddingTop: 0, marginBottom: '1.35rem', textAlign: 'left', flexShrink: 0 }}>
          <h1 style={styles.h1}>
            Link Weaver
          </h1>
        ...
        {/* Main Content - Form and List side by side on desktop, stacked on mobile */}
        <div className="link-weaver-content" style={{
          display: 'flex',
          gap: '1.35rem',
          flex: 1,
          minHeight: 0,
          ...
          {/* URL Input Form */}
          <div className="link-weaver-form" style={{
            width: '400px',
            maxWidth: '100%',
          ...
          {/* Link Nodes List */}
          <div className="link-nodes-panel" style={{
            flex: 1,
            minWidth: 0,
            display: 'flex',
            flexDirection: 'column',
