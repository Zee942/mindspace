...
const TaskCard: React.FC<{
...
}> = ({ task, skills, goals, onDelete, onAddToMap, isOnMap, onSelectTask, draggingTaskId, setDraggingTaskId, onUpdateTask }) => {
  ...
  return (
    ...
    >
      <div style={{ ...styles.taskCardContent, cursor: hasSubtasks ? 'pointer' : 'default' }} onClick={() => hasSubtasks && setIsExpanded(!isExpanded)}>
        {hasSubtasks ? (
          <svg
...
export const ActionCenter: React.FC<{
  ...
  return (
    <>
      ...
      `}</style>
      <div style={styles.actionCenterContainer} className="action-center-container">
        ...
        {actionView === 'tasks' && (
          <div className="task-board" style={styles.taskBoard}>
            {statuses.map(status => {
              ...
              return (
                <div key={status} style={{ ...styles.taskColumn }} className="task-column">
